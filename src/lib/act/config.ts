// Auto-generated shim — re-exports from @/lib/gcse-history/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _gcse_history_Config } from "@/lib/gcse-history/config";
import { EXAM_CONFIG as _raw } from "@/lib/gcse-history/config";
