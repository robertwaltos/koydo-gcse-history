...
export const metadata: Metadata = {
  title: "Pricing — Gcse History Premium",
  description: "Unlock unlimited Gcse History practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=gcse-history&cadence=annual`;
